...
module PipelinedRISCV(
    ...
    wire [31:0] MEM_ReadData_32;   // *** ADDED: Intermediate wire for 32-bit memory output ***
    ...
    Data_Memory dmem(
        ...
        .Write_Data(MEM_WriteData[31:0]),  // *** FIXED: Truncate to 32-bit ***
        .clk(clk), 
        .MemWrite(MEM_MemWrite), 
        .MemRead(MEM_MemRead), 
        .Read_Data(MEM_ReadData_32)        // *** FIXED: Read into 32-bit wire ***
    );

    // *** FIXED: Sign-Extend 32-bit Memory output back to 64-bit ***
