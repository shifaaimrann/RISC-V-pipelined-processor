...
module RISCV(
    ...
    wire [31:0] mem_read_data_32;
    // The full 64-bit read data (sign-extended)
    wire [63:0] readdata;
    ...
    Adder add_off(pc_out, immediate, off_out);
    ...
    Data_Memory dm1(
        .Mem_Addr(alu_result),      
        .Write_Data(data2[31:0]),   
        .clk(clk),
        .MemWrite(memwrite),
        .MemRead(memread),
        .Read_Data(mem_read_data_32) 
    );

    
    assign readdata = {{32{mem_read_data_32[31]}}, mem_read_data_32};
